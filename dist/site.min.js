...
$(document).ready(function(){$(".menu-icon").on("click",function(){$(".menu").toggleClass("showing")})}),$(window).on("scroll",function(){$(window).scrollTop()?$("#nav").addClass("white"):$("#nav").removeClass("white")});